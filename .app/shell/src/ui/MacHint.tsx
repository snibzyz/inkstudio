...
export type MacHintProps = {
  ...
  side?: 'top' | 'bottom'
  /** จัดกับทริกเกอร์ — start = ชิดซ้ายของไอคอน, center = กึ่งกลาง */
  align?: 'center' | 'start'
  /** wide = กล่องกว้าง, compact = แคบ */
...
/**
 * คำใบ้แบบ macOS — render ผ่าน portal ที่ document.body
 * ไม่โดนตัดโดย overflow:hidden ของ container
 */
